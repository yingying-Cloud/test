...
public class UpdateAgriculturalGreenhousesParam extends BaseZLogicParam {

	public UpdateAgriculturalGreenhousesParam(String _userId, String _apiKey, HttpServletRequest request) {
