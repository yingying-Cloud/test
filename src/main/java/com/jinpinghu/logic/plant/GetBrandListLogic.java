...
public class GetBrandListLogic extends BaseZLogic{
...
//		}
		if(StringUtils.isNullOrEmpty(isSale)||isSale.equals("1")) {
			Integer count=tbBrandDao.getBrandListCount(productName, enterpriseId, status,type,upStatus);
			if(count!=null&&count>0){
				List<Object[]> list=tbBrandDao.getBrandList(productName, enterpriseId, status, nowPage, pageCount,type,upStatus);
