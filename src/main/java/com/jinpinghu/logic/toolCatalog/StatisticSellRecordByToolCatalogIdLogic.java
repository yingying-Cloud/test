...
public class StatisticSellRecordByToolCatalogIdLogic extends BaseZLogic{
	...
	protected boolean execute(ZLogicParam logicParam, ZSimpleJsonObject res, EntityManager em) throws Exception {
		...
		Integer maxCount = toolCatalogDao.getSellRecordCountByToolCatalogIdByDscdCount(seller, buyer, startTime, endTime, toolCatalogId,
		...
		resultList = toolCatalogDao.getSellRecordByToolCatalogIdByDscd(seller, buyer, startTime, endTime, toolCatalogId, 
