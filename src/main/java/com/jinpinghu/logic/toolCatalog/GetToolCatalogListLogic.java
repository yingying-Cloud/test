...
public class GetToolCatalogListLogic extends BaseZLogic{
	...
	protected boolean execute(ZLogicParam logicParam, ZSimpleJsonObject res, EntityManager em) throws Exception {
		...
		Integer count = toolCatelogDao2.findByNameCount(name,supplierName,type,unit,code,uniformPrice,id,status,productAttributes);
		...
		List<Object[]> list = toolCatelogDao2.findByName(name,nowPage,pageCount,supplierName,type,unit,code,uniformPrice,id,status,productAttributes);
		if(list!=null) {
			for(Object[] o:list) {
