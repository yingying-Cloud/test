...
public class GetToolRecoveryRecordListParam extends BaseZLogicParam{

	public GetToolRecoveryRecordListParam(String _userId, String _apiKey, HttpServletRequest request) {
