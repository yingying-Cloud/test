...
public class GetWeChatUserInfo2Logic extends BaseZLogic {

	@Override
	protected boolean execute(ZLogicParam getUserListParam,
			ZSimpleJsonObject res, EntityManager em) throws Exception {
		
		GetWeChatUserInfo2Param myParam = (GetWeChatUserInfo2Param) getUserListParam;
		String openId = myParam.getOpenId();
		String accessToken = myParam.getAccessToken();
		String urlNameString = "https://api.weixin.qq.com/cgi-bin/user/info?access_token="
