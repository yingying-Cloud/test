...
import com.jinpinghu.logic.sellOrder.param.ExportBySellParam;
...
public class ExportBySellLogic extends BaseZLogic {

	@Override
	protected boolean execute(ZLogicParam logicParam, ZSimpleJsonObject res, EntityManager em) throws Exception {
		// TODO Auto-generated method stub
		ExportBySellParam myParam = (ExportBySellParam)logicParam;
...
//		}
		...
		List<Object[]> dataList = tbSellDao.findAllCarNum(productName, startTime, endTime,enterpriseName);
	...
	public String export(List<Map<String, Object>> dataList) throws Exception {
		...
		//创建输入流，读取模板文件
		InputStream in = new FileInputStream(TemplateFilePath + "/sellOrder.xls");
