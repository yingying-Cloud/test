...
public class GetAllEnterpriseToolStatisticLogic extends BaseZLogic{
	...
	protected boolean execute(ZLogicParam logicParam, ZSimpleJsonObject res, EntityManager em) throws Exception {
		...
		Integer allCount = statisticDao.getAllEnterpriseToolStatistic(enterpriseId);
		List<Map<String, Object>> map = statisticDao.getAllEnterpriseToolStatistic(enterpriseId,type);
		res.add("result", map);
