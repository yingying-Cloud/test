...
public class StatisticValidationDscdPeopleLogic extends BaseZLogic {

	public StatisticValidationDscdPeopleLogic() {
	...
	protected boolean execute(ZLogicParam logicParam, ZSimpleJsonObject res, EntityManager em) throws Exception {
		...
		List<Map<String, Object>> resultList = statisticDao.statisticValidationDscdPeople(selectAll,permissionEnterpriseIdList);
