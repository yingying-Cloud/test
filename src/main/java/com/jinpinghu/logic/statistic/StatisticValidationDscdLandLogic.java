...
public class StatisticValidationDscdLandLogic extends BaseZLogic {

	public StatisticValidationDscdLandLogic() {
	...
	protected boolean execute(ZLogicParam logicParam, ZSimpleJsonObject res, EntityManager em) throws Exception {
		...
		List<Map<String, Object>> resultList = statisticDao.statisticValidationDscdLand(selectAll,permissionEnterpriseIdList);
