...
public class StatisticValidationDscdEnterpriseLogic extends BaseZLogic {

	public StatisticValidationDscdEnterpriseLogic() {
	...
	protected boolean execute(ZLogicParam logicParam, ZSimpleJsonObject res, EntityManager em) throws Exception {
		...
		List<Map<String, Object>> resultList = statisticDao.statisticValidationDscdEnterprise(selectAll,permissionEnterpriseIdList);
