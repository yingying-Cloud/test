...
public class RecStatByStoreLogic extends BaseZLogic{
	...
	protected boolean execute(ZLogicParam RecStatByStreetParam, ZSimpleJsonObject res, EntityManager em) throws Exception {
		...
		Integer count = statisticDao.recStatByStoreCount(enterpriseId, startTime, endTime, selectAll, permissionEnterpriseIdList, name);
		List<Object[]> obList=statisticDao.recStatByStore(enterpriseId, startTime, endTime,  selectAll, permissionEnterpriseIdList, name, nowPage, pageCount);
