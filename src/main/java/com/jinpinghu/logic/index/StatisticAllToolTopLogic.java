...
public class StatisticAllToolTopLogic extends BaseZLogic{
	...
	protected boolean execute(ZLogicParam logicParam, ZSimpleJsonObject res, EntityManager em) throws Exception {
		...
		Integer count = indexDao.statisticAllToolTopCount();
		...
		List<Map<String,Object>> list = indexDao.statisticAllToolTop(nowPage,pageCount);
		res.add("result", list);
