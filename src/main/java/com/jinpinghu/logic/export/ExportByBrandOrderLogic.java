...
public class ExportByBrandOrderLogic extends BaseZLogic {
...
//		Integer count = brandBrandOrderDao.findByTrademarkCount(brandName, brandBrandOrderNumber, enterpriseName, beginCreateTime, endCreateTime, beginPayTime, endPayTime, status,enterpriseId,check,plantEnterpriseId,type);
...
//		}
		...
		if(list!=null) {
			for(Object[] o:list) {
				...
				TbEnterprise enterpriseS = enterpriseDao.findById(Integer.valueOf(o[15].toString()));
...
//				cell7.setCellStyle(cs);
				...
				cell8.setCellValue(orderInfoMap.containsKey("brandName")?(String) orderInfoMap.get("brandName"):"");
