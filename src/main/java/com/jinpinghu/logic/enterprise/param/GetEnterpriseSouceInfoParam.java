...
public class GetEnterpriseSouceInfoParam extends BaseZLogicParam {
    public GetEnterpriseSouceInfoParam(String _userId, String _apiKey, HttpServletRequest request) {
