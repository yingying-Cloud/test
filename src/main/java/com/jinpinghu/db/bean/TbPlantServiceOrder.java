...
/**
 * TbPlantServiceOrder entity. @author MyEclipse Persistence Tools
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "tb_plant_service_order")

public class TbPlantServiceOrder extends BaseZEntity implements java.io.Serializable {

	// Fields

	private Integer id;
	private Integer plantServiceEnterpriseId;
	...
	/** default constructor */
	public TbPlantServiceOrder() {
	}

	/** minimal constructor */
	public TbPlantServiceOrder(Integer plantServiceEnterpriseId, Integer plantEnterpriseId,
			Integer plantServiceId, String orderNumber, String price, Integer status, Date inputTime,
			Integer delFlag) {
	...
	/** full constructor */
	public TbPlantServiceOrder(Integer plantServiceEnterpriseId, Integer plantEnterpriseId,String serviceName,
			Integer plantServiceId, String addPeople, String orderNumber, String price, String area, Integer status,
	...
	@Column(name = "plant_service_enterprise_id", nullable = false)

	public Integer getPlantServiceEnterpriseId() {
		return this.plantServiceEnterpriseId;
	}

	public void setPlantServiceEnterpriseId(Integer plantServiceEnterpriseId) {
		this.plantServiceEnterpriseId = plantServiceEnterpriseId;
	}
	...
	@Column(name = "plant_service_id", nullable = false)

	public Integer getPlantServiceId() {
		return this.plantServiceId;
	}
