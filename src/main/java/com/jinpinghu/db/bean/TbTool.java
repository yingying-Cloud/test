...
public class TbTool extends BaseZEntity  implements java.io.Serializable {
	...
	/** minimal constructor */
	public TbTool(Integer enterpriseId, String name, String price, Integer delFlag) {
	...
	/** full constructor */
	public TbTool(Integer enterpriseId, String name, String model,  String specification, String unit,
