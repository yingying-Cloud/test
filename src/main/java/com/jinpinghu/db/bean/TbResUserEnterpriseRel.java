...
@Entity
@Table(name = "tb_res_user_enterprise_rel")

public class TbResUserEnterpriseRel extends BaseZEntity  implements java.io.Serializable {
	...
	/** default constructor */
	public TbResUserEnterpriseRel() {
	}

	/** full constructor */
	public TbResUserEnterpriseRel(Integer userTabId, Integer enterpriseId, Integer delFlag) {
