...
@Entity
@Table(name = "tb_brand_shopping_car")

public class TbBrandShoppingCar extends BaseZEntity  implements java.io.Serializable {
	...
	/** default constructor */
	public TbBrandShoppingCar() {
	}

	/** minimal constructor */
	public TbBrandShoppingCar(Integer brandId, String num, String price, Integer delFlag) {
