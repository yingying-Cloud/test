...
@Entity
@Table(name = "tb_sell_order")

public class TbSellOrder extends BaseZEntity  implements java.io.Serializable {
	...
	/** minimal constructor */
	public TbSellOrder(Integer enterpriseId, String orderNumber, Integer status,
	...
	/** full constructor */
	public TbSellOrder(Integer enterpriseId, String addPeople, String orderNumber,
